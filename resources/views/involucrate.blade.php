...
<div id="section1" class="fd-tomate blanco centrar seccion1">
	...
	<div class="row">
		...
		<div class="col-md-7">
			...
			<h3>Aprende como implementar ReciVeci en tu barrio.</h3>		
		</div>
		<div class="col-md-3">
			<span><a href="files/FAQs.docx" download="Manual ReciVeci" class="descarga">Descargar el<br>Manual ReciVeci</a>	</span>
		</div>
		<div class="col-md-1"></div>
	</div>
...
<div id="section2" class="fd-azul seccion2">
